...
/*   Updated: 2023/02/13 14:51:11 by prossi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void fill_constructor()
{
    ...
    std::cout <<  "fill constructor: " <<  "OK" << std::endl;
}
...
static void assignement_operator()
{
    ...
    std::cout <<  "assignement_operator: " <<  "OK" << std::endl;
}
...
static void front_back()
{
    ...
    std::cout <<  "front && back: " <<  "OK" << std::endl;
}
...
static void access_operator()
{
    ...
    std::cout <<  "access operator: " <<  "OK" << std::endl;
}
...
static void relational_operators()
{
    ...
    std::cout <<  "relational operators: " <<  "OK" << std::endl;
}
...
int main()
{
    std::cout << "========= TEST FT::VECTOR =========" << std::endl;
